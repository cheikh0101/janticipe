...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            <form method="POST" action=" {{route('aine.update',$aine)}} ">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Prénom</label>
                    <input type="text" name="prenom" required id="" value="{{$aine->prenom}}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nom" required id="" value="{{$aine->nom}}" class="form-control"
                        aria-describedby="helpId">
                    <small id="helpId" class="text-danger">*champ obligatoire</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="num_telephone" required id="" class="form-control"
                        value="{{$aine->num_telephone}}" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">*champ obligatoire</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="adresse_mail" required id="" class="form-control" value="
                        {{$aine->adresse_mail}}" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">*champ obligatoire</small>
                </div>
