                ...
                <div class="accordion-body">
                    <div class="row g-5 py-5">
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Développement d'une application mobile de gestion de l'itinéraire technique d'un
                                    périmètre maraîcher.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Développement d'une application de gestion d'un cabinet de médecine traditionnelle
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Portail de gestion de voyageurs avec plusieurs voyagistes regroupés en groupe :
                                    exemple du pèlerinage.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row g-5 py-5">
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">RT</h2>
                                <p>Modélisation d'un système de transmission numérique sous Matlab Simulink.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">RT</h2>
                                <p>Mise en place d'un cloud privé sous owncloud.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">RT</h2>
                                <p>Mise en place d'une plateforme d'authentification wifi avec NPS et ActiveDrirectory
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="row g-5 py-5">
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Gestion de l'intermédiation entre les acteurs du BTP et les services financiers.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Gestion d'une suite de restaurants : commandes et menus en ligne. Les clients peuvent
                                    venir manger ou payer un supplément pour le transport. Paiement utilisant les
                                    services actuels (Wari, Joni Joni, etc.)
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light border p-2 rounded-3">
                                <h2 class="border-bottom">GL</h2>
                                <p>Développement d'une application de distribution de ressources basée sur un ensemble
                                    de contraintes : exemple de l'héritage</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-body">
                    ...
                    <div class="row">
                        <div class="feature col-md-4">
                            <h2>PHP</h2>
                            <p>
                                L’objectif de cet projet est de mettre en place une boutique en ligne avec la gestion
                                des
                                produits.
                            </p>
                    ...
                    <div class="row">
                        <div class="feature col-md-4">
                            <h2>JAVA</h2>
                            <p>
                                Le projet a pour but d’appliquer les principes des systèmes d’exploitation afin de
                                réaliser
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Proposition de Projet Opérationnel
                </button>
            </h2>
...
<button type="button" class="btn btn-primary d-none" data-toggle="modal" data-target="#myModal">
    Open modal
</button>
...
const boutonTrigger = document.querySelector('.btn');
