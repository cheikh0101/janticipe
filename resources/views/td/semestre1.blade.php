...
<div class="container py-5" id="featured-3">
    ...
    <div class="row g-5 py-5">
        <div class="feature col-md-4">
            ...
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" id="mathematique1"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    Disponible
                </button>
                <ul class="dropdown-menu" aria-labelledby="mathematique1">
        ...
        <div class="feature col-md-4">
            ...
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" id="fondamentaux"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    Fondamentaux
                </button>
                <ul class="dropdown-menu" aria-labelledby="fondamentaux">
                ...
                <button class="btn btn-primary dropdown-toggle" type="button" id="electricite" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    Electricité
                </button>
                <ul class="dropdown-menu" aria-labelledby="electricite">
        ...
        <div class="feature col-md-4">
            ...
            <button href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tdInformatique1">
                Disponible
            </button>
            <!-- Modal -->
                                    ...
                                    <ul>
                                        <li>
                                            <ol>
                                                ...
                                                <li>
                                                    <a
                                                        href="https://github.com/cheikh0101/correctionAlgo1/blob/main/fiche1/exo1.c">
                                        ...
                                        <li>
                                            <ol>
                                                ...
                                                <li>
                                                    <a
                                                        href="https://github.com/cheikh0101/correctionAlgo1/tree/main/fiche2">
                                                        Proposition de Correction
                                                    </a>
                                                </li>
                                            </ol>
                                        ...
                                        <li>
                                            <ol>
                                                ...
                                                <li>
                                                    <a
                                                        href="https://github.com/cheikh0101/correctionAlgo1/tree/main/fiche3">Proposition
                                                        de Correction</a>
                                                </li>
                                            </ol>
